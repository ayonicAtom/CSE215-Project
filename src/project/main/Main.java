...
public class Main {
    ...
    public static void editCoach() {
        ...
        String name = InputHelper.read("Name [" + c.getName() + "]: ");
        if (!name.isEmpty()) c.setName(name);

        String age = InputHelper.read("Age [" + c.getAge() + "]: ");
        if (!age.isEmpty()) {
            try {
        ...
        String nationality = InputHelper.read("Nationality [" + c.getNationality() + "]: ");
        if (!nationality.isEmpty()) c.setNationality(nationality);

        String speciality = InputHelper.read("Speciality [" + c.getSpeciality() + "]: ");
