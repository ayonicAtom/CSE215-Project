...
public class Main {
    ...
    public static void menu() {
        while (true) {
            ...
            System.out.println("5. Add Team To League");
            System.out.println("6. Edit Information");
            System.out.println("7. Remove Player From Team");
            System.out.println("8. Remove Team From League");
            ...
            switch (option) {
                ...
                case 6 -> editMenu();
                case 7 -> removePlayerFromTeam();
                case 8 -> removeTeamFromLeague();
                case 9 -> Statistics();
                case 0 -> {
                    return;
                }
    ...
    public static void createPlayer() {
        ...
        Player p = new Player(name, age, height, nationality, goals, assists, position);
        playerService.add(p);
        p.displayPlayerInfo();
    }
